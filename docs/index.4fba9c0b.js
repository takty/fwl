...
class LayoutSample {
    ...
    #fl;
    initialize() {
        this.#fl = new _fwlEsmJs.FlexibleLayout();
    ...
    start() {
        ...
        return this.#fl.layoutContainer({
            width,
            height
        });
    }
...
parcelHelpers.export(exports, "Button", ()=>$67bc1645818d9dfb$export$353f5b6fc5456de1);
parcelHelpers.export(exports, "Checkbox", ()=>$69a47cf6b0d23842$export$48513f6b9f8ce62d);
parcelHelpers.export(exports, "Checkboxes", ()=>$a9c8def4b94681c3$export$2bc6b1ab4f9a3f);
parcelHelpers.export(exports, "Label", ()=>$6c669da18eb1d4af$export$b04be29aa201d4f5);
parcelHelpers.export(exports, "ListBox", ()=>$0313106492189ea8$export$41f133550aa26f48);
parcelHelpers.export(exports, "RadioButtons", ()=>$1bf1cd471ae02e23$export$3f5c08aebfbff744);
parcelHelpers.export(exports, "Layout", ()=>$02bdab161dfe53b8$export$c84671f46d6a1ca);
parcelHelpers.export(exports, "HorizontalArray", ()=>$1f148bf72ade7c2a$export$fbfad3d19c15cd04);
parcelHelpers.export(exports, "VerticalArray", ()=>$cc4dcb80c3852878$export$51fe83e77e0dadce);
parcelHelpers.export(exports, "LeftLabeling", ()=>$a2dbf6a4680ed696$export$18b48faa63195070);
parcelHelpers.export(exports, "TopLabeling", ()=>$4884c9bf4266a772$export$3d88a90b20ff9f03);
parcelHelpers.export(exports, "FElement", ()=>$b4524a03ecc9c659$export$d00c746f5a6c6b);
parcelHelpers.export(exports, "FControl", ()=>$e331cc23c1a10408$export$8884abd4be69784e);
parcelHelpers.export(exports, "Caption", ()=>$d657159227f697e6$export$32fbfacc5d962e0c);
parcelHelpers.export(exports, "Multiple", ()=>$2a82b9db6f278b76$export$96933ea99fed18ef);
parcelHelpers.export(exports, "Single", ()=>$d2b180a3a10064d6$export$446647c06aeeba4e);
parcelHelpers.export(exports, "SingleBoolean", ()=>$1db3cea13b9cc444$export$ec067bcfcebc17c);
parcelHelpers.export(exports, "FLayout", ()=>$56599b1fb7a9d24d$export$a32a3c53df62fb64);
...
var $7f32230d3b1cddf5$exports = {};
$parcel$export($7f32230d3b1cddf5$exports, "Control", ()=>$7f32230d3b1cddf5$export$7a7fa4424cb20976);
class $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    #degree;
    #minSize = {
        width: 0,
        height: 0
...
var $67bc1645818d9dfb$exports = {};
$parcel$export($67bc1645818d9dfb$exports, "Button", ()=>$67bc1645818d9dfb$export$353f5b6fc5456de1);
class $67bc1645818d9dfb$export$353f5b6fc5456de1 extends $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    #text;
...
$parcel$export($69a47cf6b0d23842$exports, "Checkbox", ()=>$69a47cf6b0d23842$export$48513f6b9f8ce62d);
class $69a47cf6b0d23842$export$48513f6b9f8ce62d extends $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    #text;
    constructor(owner, deg, text){
        super(owner, deg);
        this.#text = text;
...
$parcel$export($a9c8def4b94681c3$exports, "Checkboxes", ()=>$a9c8def4b94681c3$export$2bc6b1ab4f9a3f);
class $a9c8def4b94681c3$export$2bc6b1ab4f9a3f extends $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    #items;
...
$parcel$export($6c669da18eb1d4af$exports, "Label", ()=>$6c669da18eb1d4af$export$b04be29aa201d4f5);
class $6c669da18eb1d4af$export$b04be29aa201d4f5 extends $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    #text;
    constructor(owner, deg, text){
        super(owner, deg);
        this.#text = text;
...
$parcel$export($0313106492189ea8$exports, "ListBox", ()=>$0313106492189ea8$export$41f133550aa26f48);
class $0313106492189ea8$export$41f133550aa26f48 extends $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    static MIN_ITEM_SIZE = 4;
    #items;
    static createVariableInstances(minDeg, maxDeg, items) {
        if (items.length <= $0313106492189ea8$export$41f133550aa26f48.MIN_ITEM_SIZE) return [
            [
                maxDeg,
                (owner)=>new $0313106492189ea8$export$41f133550aa26f48(owner, maxDeg, items, $0313106492189ea8$export$41f133550aa26f48.MIN_ITEM_SIZE)
            ]
        ];
        const ret = [];
        const rDeg = maxDeg - minDeg;
        for(let i = $0313106492189ea8$export$41f133550aa26f48.MIN_ITEM_SIZE + 1; i < items.length; ++i){
            const r = maxDeg + rDeg * (i / items.length - 1);
            const count = i;
            ret.push([
                r,
                (owner)=>new $0313106492189ea8$export$41f133550aa26f48(owner, r, items, count)
            ]);
        }
        return ret;
    }
    constructor(owner, deg, items, count = items.length){
        ...
        const minH = Math.min(count, $0313106492189ea8$export$41f133550aa26f48.MIN_ITEM_SIZE) * 1;
        let maxLen = 0;
        for (const it of items)maxLen = Math.max(maxLen, it.length);
        this.setMinimumSize({
            width: maxLen + 1,
...
$parcel$export($1bf1cd471ae02e23$exports, "RadioButtons", ()=>$1bf1cd471ae02e23$export$3f5c08aebfbff744);
class $1bf1cd471ae02e23$export$3f5c08aebfbff744 extends $7f32230d3b1cddf5$export$7a7fa4424cb20976 {
    #items;
    constructor(owner, deg, items){
        super(owner, deg);
        this.#items = [
...
$parcel$export($02bdab161dfe53b8$exports, "Layout", ()=>$02bdab161dfe53b8$export$c84671f46d6a1ca);
class $02bdab161dfe53b8$export$c84671f46d6a1ca {
    static NO_DIR = -1;
    static VERTICAL = 0;
    static HORIZONTAL = 1;
    #owner;
    #degree;
    #direction;
    constructor(owner, degree, direction = $02bdab161dfe53b8$export$c84671f46d6a1ca.NO_DIR){
        this.#owner = owner;
        this.#degree = degree;
...
var $1f148bf72ade7c2a$exports = {};
$parcel$export($1f148bf72ade7c2a$exports, "HorizontalArray", ()=>$1f148bf72ade7c2a$export$fbfad3d19c15cd04);
var $56599b1fb7a9d24d$exports = {};
$parcel$export($56599b1fb7a9d24d$exports, "FLayout", ()=>$56599b1fb7a9d24d$export$a32a3c53df62fb64);
var $b4524a03ecc9c659$exports = {};
$parcel$export($b4524a03ecc9c659$exports, "FElement", ()=>$b4524a03ecc9c659$export$d00c746f5a6c6b);
class $b4524a03ecc9c659$export$d00c746f5a6c6b {
    #parent = null;
    #type = null;
    #size = {
        width: 0,
    ...
    _typeToCandidate(val = null) {
        ...
        if (this._states[val]) return this._cans[this._states[val].comb[0]];
        return null;
    }
    isValid() {
...
class $56599b1fb7a9d24d$export$a32a3c53df62fb64 extends $b4524a03ecc9c659$export$d00c746f5a6c6b {
    ...
    getDescendantSize() {
        ...
        for (const c of this.#children)if (c instanceof $56599b1fb7a9d24d$export$a32a3c53df62fb64) size += c.getDescendantSize();
        return size;
    }
    // -------------------------------------------------------------------------
    initializeProblem(p) {
    ...
    addPossibleDegreesTo(dest) {
        ...
        dest.add($56599b1fb7a9d24d$export$a32a3c53df62fb64.SAME_DIRECTION);
    }
    // -------------------------------------------------------------------------
    doLayout() {
        const can = this._typeToCandidate();
...
class $1f148bf72ade7c2a$export$fbfad3d19c15cd04 extends $02bdab161dfe53b8$export$c84671f46d6a1ca {
    ...
    doLayout(children, size) {
        ...
        for (const fe of children){
            ...
            fe.setLocation(x, 1);
            if (fe instanceof $56599b1fb7a9d24d$export$a32a3c53df62fb64) fe.doLayout();
            x += fe.getSize().width + 1;
        }
    }
}
var $cc4dcb80c3852878$exports = {};
$parcel$export($cc4dcb80c3852878$exports, "VerticalArray", ()=>$cc4dcb80c3852878$export$51fe83e77e0dadce);
class $cc4dcb80c3852878$export$51fe83e77e0dadce extends $02bdab161dfe53b8$export$c84671f46d6a1ca {
    constructor(owner, deg){
...
var $a2dbf6a4680ed696$exports = {};
$parcel$export($a2dbf6a4680ed696$exports, "LeftLabeling", ()=>$a2dbf6a4680ed696$export$18b48faa63195070);
class $a2dbf6a4680ed696$export$18b48faa63195070 extends $02bdab161dfe53b8$export$c84671f46d6a1ca {
    constructor(owner, deg){
        super(owner, deg, $02bdab161dfe53b8$export$c84671f46d6a1ca.HORIZONTAL);
    }
    name() {
    ...
    doLayout(children, size) {
        ...
        if (ce instanceof $56599b1fb7a9d24d$export$a32a3c53df62fb64) ce.doLayout();
    }
}
var $4884c9bf4266a772$exports = {};
$parcel$export($4884c9bf4266a772$exports, "TopLabeling", ()=>$4884c9bf4266a772$export$3d88a90b20ff9f03);
class $4884c9bf4266a772$export$3d88a90b20ff9f03 extends $02bdab161dfe53b8$export$c84671f46d6a1ca {
    #indent = 1;
    constructor(owner, deg){
        super(owner, deg, $02bdab161dfe53b8$export$c84671f46d6a1ca.VERTICAL);
    }
...
var $e331cc23c1a10408$exports = {};
$parcel$export($e331cc23c1a10408$exports, "FControl", ()=>$e331cc23c1a10408$export$8884abd4be69784e);
...
var $d657159227f697e6$exports = {};
$parcel$export($d657159227f697e6$exports, "Caption", ()=>$d657159227f697e6$export$32fbfacc5d962e0c);
class $d657159227f697e6$export$32fbfacc5d962e0c extends $e331cc23c1a10408$export$8884abd4be69784e {
    #longText;
    #shortText;
    ...
    _getCandidateEntries() {
        return [
            [
                1.0,
                (owner)=>new $6c669da18eb1d4af$export$b04be29aa201d4f5(owner, 1.0, this.#longText)
            ],
            [
                0.8,
                (owner)=>new $6c669da18eb1d4af$export$b04be29aa201d4f5(owner, 0.8, this.#shortText)
            ]
        ];
    }
}
var $2a82b9db6f278b76$exports = {};
$parcel$export($2a82b9db6f278b76$exports, "Multiple", ()=>$2a82b9db6f278b76$export$96933ea99fed18ef);
class $2a82b9db6f278b76$export$96933ea99fed18ef extends $e331cc23c1a10408$export$8884abd4be69784e {
    #items;
    constructor(...items){
        super();
        this.#items = items;
    ...
    _getCandidateEntries() {
        ...
        r.push([
            1.0,
            (owner)=>new Checkboxes(owner, 1.0, this.#items)
        ]);
        return r;
    }
}
var $d2b180a3a10064d6$exports = {};
$parcel$export($d2b180a3a10064d6$exports, "Single", ()=>$d2b180a3a10064d6$export$446647c06aeeba4e);
class $d2b180a3a10064d6$export$446647c06aeeba4e extends $e331cc23c1a10408$export$8884abd4be69784e {
    #items;
    constructor(...items){
        super();
        this.#items = items;
    ...
    _getCandidateEntries() {
        ...
        r.push([
            1.0,
            (owner)=>new $1bf1cd471ae02e23$export$3f5c08aebfbff744(owner, 1.0, this.#items)
        ]);
        return r;
    }
}
var $1db3cea13b9cc444$exports = {};
$parcel$export($1db3cea13b9cc444$exports, "SingleBoolean", ()=>$1db3cea13b9cc444$export$ec067bcfcebc17c);
class $1db3cea13b9cc444$export$ec067bcfcebc17c extends $e331cc23c1a10408$export$8884abd4be69784e {
    #itemTrue;
    #itemFalse;
    ...
    _getCandidateEntries() {
        return [
            [
                0.9,
                (owner)=>new $69a47cf6b0d23842$export$48513f6b9f8ce62d(owner, 0.9, this.#itemTrue)
            ],
            [
                1.0,
                (owner)=>new $1bf1cd471ae02e23$export$3f5c08aebfbff744(owner, 1.0, [
                        this.#itemTrue,
                        this.#itemFalse
                    ])
            ]
...
var $97bc4c7e48814405$exports = {};
$parcel$export($97bc4c7e48814405$exports, "Group", ()=>$97bc4c7e48814405$export$eb2fcfdbd7ba97d4);
class $97bc4c7e48814405$export$eb2fcfdbd7ba97d4 extends $56599b1fb7a9d24d$export$a32a3c53df62fb64 {
    constructor(args){
        super();
    ...
    _getCandidateEntries() {
        return [
            [
                0.98,
                (owner)=>new $1f148bf72ade7c2a$export$fbfad3d19c15cd04(owner, 0.98)
            ],
            [
                1.0,
                (owner)=>new $cc4dcb80c3852878$export$51fe83e77e0dadce(owner, 1.0)
            ]
        ];
    }
}
var $01b7303749d42b99$exports = {};
$parcel$export($01b7303749d42b99$exports, "Labeling", ()=>$01b7303749d42b99$export$7f9751bb9f40e790);
class $01b7303749d42b99$export$7f9751bb9f40e790 extends $56599b1fb7a9d24d$export$a32a3c53df62fb64 {
    ...
    _getCandidateEntries() {
        return [
            [
                1.0,
                (owner)=>new $a2dbf6a4680ed696$export$18b48faa63195070(owner, 1)
            ],
            [
                0.9,
                (owner)=>new $4884c9bf4266a772$export$3d88a90b20ff9f03(owner, 0.9)
            ]
        ];
    }
}
var $3daa3e638ff94731$exports = {};
$parcel$export($3daa3e638ff94731$exports, "FlexibleLayout", ()=>$3daa3e638ff94731$export$bfecdd4c292f614d);
class $3daa3e638ff94731$export$bfecdd4c292f614d {
    static DEBUG = true;
    ...
    #sortVariablesInBreadthFirstOrder(p2) {
        ...
        while(ls.length > 0){
            const nls = [];
            for (const l of ls){
                for (const c of l.children())if (c instanceof $56599b1fb7a9d24d$export$a32a3c53df62fb64) nls.push(c);
            }
